...
class Notes:
    ...
    def create_note(self, id, article_id: int, text: str) -> dict:
    ...
    def update_note(self, id, article_id: int, note_id: int, text: str) -> dict:
        return self.__rayyan__.request.request_handler(
            method="PUT",
    ...
    def delete_note(self, id, article_id: int, note_id: int) -> dict:
        return self.__rayyan__.request.request_handler(
            method="DELETE",
            path=f"{REVIEWS_ROUTE}/{id}/articles/{article_id}/notes/{note_id}",
        )
